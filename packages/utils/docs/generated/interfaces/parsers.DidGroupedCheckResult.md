[@windingtree/org.id-utils](../README.md) / [parsers](../modules/parsers.md) / DidGroupedCheckResult

# Interface: DidGroupedCheckResult

[parsers](../modules/parsers.md).DidGroupedCheckResult
...
- [groups](parsers.DidGroupedCheckResult.md#groups)
- [index](parsers.DidGroupedCheckResult.md#index)
- [input](parsers.DidGroupedCheckResult.md#input)
- [length](parsers.DidGroupedCheckResult.md#length)

### Methods

- [[iterator]](parsers.DidGroupedCheckResult.md#[iterator])
- [[unscopables]](parsers.DidGroupedCheckResult.md#[unscopables])
- [at](parsers.DidGroupedCheckResult.md#at)
- [concat](parsers.DidGroupedCheckResult.md#concat)
- [copyWithin](parsers.DidGroupedCheckResult.md#copywithin)
- [entries](parsers.DidGroupedCheckResult.md#entries)
- [every](parsers.DidGroupedCheckResult.md#every)
- [fill](parsers.DidGroupedCheckResult.md#fill)
- [filter](parsers.DidGroupedCheckResult.md#filter)
- [find](parsers.DidGroupedCheckResult.md#find)
- [findIndex](parsers.DidGroupedCheckResult.md#findindex)
- [flat](parsers.DidGroupedCheckResult.md#flat)
- [flatMap](parsers.DidGroupedCheckResult.md#flatmap)
- [forEach](parsers.DidGroupedCheckResult.md#foreach)
- [includes](parsers.DidGroupedCheckResult.md#includes)
- [indexOf](parsers.DidGroupedCheckResult.md#indexof)
- [join](parsers.DidGroupedCheckResult.md#join)
- [keys](parsers.DidGroupedCheckResult.md#keys)
- [lastIndexOf](parsers.DidGroupedCheckResult.md#lastindexof)
- [map](parsers.DidGroupedCheckResult.md#map)
- [pop](parsers.DidGroupedCheckResult.md#pop)
- [push](parsers.DidGroupedCheckResult.md#push)
- [reduce](parsers.DidGroupedCheckResult.md#reduce)
- [reduceRight](parsers.DidGroupedCheckResult.md#reduceright)
- [reverse](parsers.DidGroupedCheckResult.md#reverse)
- [shift](parsers.DidGroupedCheckResult.md#shift)
- [slice](parsers.DidGroupedCheckResult.md#slice)
- [some](parsers.DidGroupedCheckResult.md#some)
- [sort](parsers.DidGroupedCheckResult.md#sort)
- [splice](parsers.DidGroupedCheckResult.md#splice)
- [toLocaleString](parsers.DidGroupedCheckResult.md#tolocalestring)
- [toString](parsers.DidGroupedCheckResult.md#tostring)
- [unshift](parsers.DidGroupedCheckResult.md#unshift)
- [values](parsers.DidGroupedCheckResult.md#values)
...
[src/parsers/index.ts:24](https://github.com/windingtree/org.id-sdk/blob/6904194/packages/utils/src/parsers/index.ts#L24)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`DidGroupedCheckResult`](parsers.DidGroupedCheckResult.md)
...
[`DidGroupedCheckResult`](parsers.DidGroupedCheckResult.md)
...
▸ **fill**(`value`, `start?`, `end?`): [`DidGroupedCheckResult`](parsers.DidGroupedCheckResult.md)
...
▸ **sort**(`compareFn?`): [`DidGroupedCheckResult`](parsers.DidGroupedCheckResult.md)
