[@windingtree/org.id-utils](../README.md) / [parsers](../modules/parsers.md) / IpfsUriGroupedResult

# Interface: IpfsUriGroupedResult

[parsers](../modules/parsers.md).IpfsUriGroupedResult

## Hierarchy

- `RegExpExecArray`

  ↳ **`IpfsUriGroupedResult`**

## Table of contents

### Properties

- [groups](parsers.IpfsUriGroupedResult.md#groups)
- [index](parsers.IpfsUriGroupedResult.md#index)
- [input](parsers.IpfsUriGroupedResult.md#input)
- [length](parsers.IpfsUriGroupedResult.md#length)

### Methods

- [[iterator]](parsers.IpfsUriGroupedResult.md#[iterator])
- [[unscopables]](parsers.IpfsUriGroupedResult.md#[unscopables])
- [at](parsers.IpfsUriGroupedResult.md#at)
- [concat](parsers.IpfsUriGroupedResult.md#concat)
- [copyWithin](parsers.IpfsUriGroupedResult.md#copywithin)
- [entries](parsers.IpfsUriGroupedResult.md#entries)
- [every](parsers.IpfsUriGroupedResult.md#every)
- [fill](parsers.IpfsUriGroupedResult.md#fill)
- [filter](parsers.IpfsUriGroupedResult.md#filter)
- [find](parsers.IpfsUriGroupedResult.md#find)
- [findIndex](parsers.IpfsUriGroupedResult.md#findindex)
- [flat](parsers.IpfsUriGroupedResult.md#flat)
- [flatMap](parsers.IpfsUriGroupedResult.md#flatmap)
- [forEach](parsers.IpfsUriGroupedResult.md#foreach)
- [includes](parsers.IpfsUriGroupedResult.md#includes)
- [indexOf](parsers.IpfsUriGroupedResult.md#indexof)
- [join](parsers.IpfsUriGroupedResult.md#join)
- [keys](parsers.IpfsUriGroupedResult.md#keys)
- [lastIndexOf](parsers.IpfsUriGroupedResult.md#lastindexof)
- [map](parsers.IpfsUriGroupedResult.md#map)
- [pop](parsers.IpfsUriGroupedResult.md#pop)
- [push](parsers.IpfsUriGroupedResult.md#push)
- [reduce](parsers.IpfsUriGroupedResult.md#reduce)
- [reduceRight](parsers.IpfsUriGroupedResult.md#reduceright)
- [reverse](parsers.IpfsUriGroupedResult.md#reverse)
- [shift](parsers.IpfsUriGroupedResult.md#shift)
- [slice](parsers.IpfsUriGroupedResult.md#slice)
- [some](parsers.IpfsUriGroupedResult.md#some)
- [sort](parsers.IpfsUriGroupedResult.md#sort)
- [splice](parsers.IpfsUriGroupedResult.md#splice)
- [toLocaleString](parsers.IpfsUriGroupedResult.md#tolocalestring)
- [toString](parsers.IpfsUriGroupedResult.md#tostring)
- [unshift](parsers.IpfsUriGroupedResult.md#unshift)
- [values](parsers.IpfsUriGroupedResult.md#values)
...
[src/parsers/index.ts:35](https://github.com/windingtree/org.id-sdk/blob/6904194/packages/utils/src/parsers/index.ts#L35)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`IpfsUriGroupedResult`](parsers.IpfsUriGroupedResult.md)
...
[`IpfsUriGroupedResult`](parsers.IpfsUriGroupedResult.md)
...
▸ **fill**(`value`, `start?`, `end?`): [`IpfsUriGroupedResult`](parsers.IpfsUriGroupedResult.md)
...
▸ **sort**(`compareFn?`): [`IpfsUriGroupedResult`](parsers.IpfsUriGroupedResult.md)
